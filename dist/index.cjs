...
__export(src_exports, {
    ...
    runpodServerlessBaseUrlDev: function() {
        return runpodServerlessBaseUrlDev;
    },
    runpodServerlessBaseUrlProd: function() {
        return runpodServerlessBaseUrlProd;
    },
    status: function() {
        return status;
    },
...
var getEndpointUrl = (0, import_ramda.curry)(function(baseUrl, endpointId) {
...
var runSync = (0, import_ramda.curry)(function() {
            ...
            switch(_state.label){
                case 0:
                    ...
                    getRemainingTime = function() {
                        return (0, import_ramda.clamp)(1e3, 9e4, timeout - (Date.now() - startTime));
                    };
                    return [
                        4,
...
var statusSync = (0, import_ramda.curry)(function(baseUrl, apiKey, endpointId, requestId) {
...
var status = (0, import_ramda.curry)(function(baseUrl, apiKey, endpointId, requestId) {
    var timeout = arguments.length > 4 && arguments[4] !== void 0 ? arguments[4] : 3e3;
...
var cancel = (0, import_ramda.curry)(function(baseUrl, apiKey, endpointId, requestId) {
    var timeout = arguments.length > 4 && arguments[4] !== void 0 ? arguments[4] : 3e3;
...
var health = (0, import_ramda.curry)(function(baseUrl, apiKey, endpointId) {
...
var purgeQueue = (0, import_ramda.curry)(function(baseUrl, apiKey, endpointId) {
    var timeout = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : 3e3;
...
var RunpodSdk = /*#__PURE__*/ function() {
    function RunpodSdk(apiKey, options) {
        ...
        this.apiKey = "";
        this.baseUrl = runpodServerlessBaseUrlProd;
        if ((0, import_ramda.isNil)(apiKey)) {
    ...
    _create_class(RunpodSdk, [
        {
            ...
            value: function endpoint(endpointId) {
                if ((0, import_ramda.isNil)(endpointId)) {
...
0 && (module.exports = {
    ...
    run: run,
    runSync: runSync,
    runpodServerlessBaseUrlDev: runpodServerlessBaseUrlDev,
    runpodServerlessBaseUrlProd: runpodServerlessBaseUrlProd,
    status: status,
    stream: stream
});
